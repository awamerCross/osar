...
function OrderData({ navigation, route }) {
  ...
  const provider_id = route.params.provider_id
    ...
    : null;
  const providerAddress = route.params.providerAddress
    ? route.params.providerAddress
    : "";
  ...
  const [
    isDeliveryTimePickerVisible,
    setDeliveryTimePickerVisibility,
  ] = useState(false);
      ...
      if (route.params?.cityName && route.params.pathName == "getLoc") {
        ...
        dispatch(
          getDeliveryPrice(
            lang,
            provider_id,
            route.params?.mapRegion.latitude,
            route.params?.mapRegion.longitude,
            token
          )
        );
      } else {
          ...
          <KeyboardAvoidingView style={[styles.Width_100]}>
            <Form style={[styles.Width_100, styles.flexCenter]}>
                  ...
                  Icon={() => {
                    return (
                      <Image
                        ...
                        style={[styles.icon15, { top: isIOS ? 7 : 18 }]}
                        resizeMode={"contain"}
                      />
                    );
                  }}
                ...
                <>
                  ...
                  <Item style={[styles.item]}>
                    ...
                    <Input
                      ...
                      onChangeText={(friendPhone) =>
                        setFriendPhone(friendPhone)
                      }
              ...
              <Item style={[styles.item]}>
                ...
                />
                <TouchableOpacity
                  onPress={showDeliveryTimePicker}
                  style={[{ position: "absolute", right: 10, bottom: 13 }]}
                >
                  <Icon
                    type={"AntDesign"}
              ...
              >
                {i18n.t("selectPayMethod")}
              </Text>

              <View
                style={[
                  IS_IPHONE_X ? styles.directionRowCenter : styles.rowGroup,
                  styles.Width_100,
                  { flexWrap: "wrap" },
                ]}
              >
                <TouchableOpacity
                  ...
                  style={[
                    payType === "cash" ? styles.bg_light_gray : null,
                    styles.marginBottom_10,
                    styles.Radius_10,
                    styles.overHidden,
                    styles.width_90,
                ...
                >
                  <Image
                    source={require("../../assets/images/money_cash.png")}
                    style={[styles.icon50]}
                    resizeMode={"contain"}
                  />
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  onPress={() => setPayType("online")}
                  style={[
                    payType === "online" ? styles.bg_light_gray : null,
                    styles.marginBottom_10,
                    styles.Radius_10,
                    styles.overHidden,
                    styles.width_90,
                ...
                <TouchableOpacity
                  onPress={() => setPayType("wallet")}
                  style={[
                    payType === "wallet" ? styles.bg_light_gray : null,
                    styles.marginBottom_10,
                    styles.Radius_10,
                    styles.overHidden,
                    styles.width_90,
                ...
                >
                  <Image
                    source={require("../../assets/images/payWallet.png")}
                    style={[styles.icon50]}
                    resizeMode={"contain"}
                  />
                </TouchableOpacity>
              ...
              {receiveWay !== "restaurant" ? (
                ...
                >
                  ...
                  >
                    ...
                    {deliveryPrice && cityName ? deliveryPrice?.delivery : 0}{" "}
                    {i18n.t("RS")}
                  </Text>
                </View>
              ) : null}
