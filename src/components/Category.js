...
function Category({ navigation, route }) {
  ...
  const fetchData = async () => {
    ...
    dispatch(
      getProviders(lang, category_id, false, null, null, null)
  ...
  const onSearchFilter = (keyword) => {
    ...
    if (keyword) {
      dispatch(
        getProviders(lang, category_id, false, null, null, keyword)
      ).then(() => setScreenLoader(false));
    }
    dispatch(
      getProviders(lang, category_id, false, null, null, null)
  ...
  const onRateProvider = () => {
    setScreenLoader(true);
    dispatch(getProviders(lang, category_id, true, null, null, null)).then(() =>
