...
function Profile({ navigation, route }) {
  ...
  function fetchData() {
    ...
    dispatch(profile(lang, token)).then(() => {
  ...
  function renderSubmit() {
    if (phone == "" || username == "" || mail == "") {
      return (
        ...
        >
          <Text style={[styles.textBold, styles.text_gray, styles.textSize_15]}>
            {i18n.t("editProfile")}
          </Text>
        </View>
      );
    ...
    return (
      ...
      >
        <Text style={[styles.textBold, styles.text_White, styles.textSize_15]}>
          {i18n.t("editProfile")}
        </Text>
      </TouchableOpacity>
    );
  ...
  function onConfirm() {
    setScreenLoader(true);
    dispatch(updateProfile(lang, username, phone, mail, base64, token)).then(
      () => {
        setScreenLoader(false);
        setUserImage(null);
      }
  ...
  function onConfirmPass() {
    if (newpass.length < 6) {
      ...
      setIsSubmitted(true);
      dispatch(changePass(lang, password, newpass, token)).then(() => {
    ...
    return (
      <View
        style={[
          ...
          { flex: 1, borderBottomWidth: 1, borderColor: "#ddd" },
        ]}
      >
        <View
          style={[
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                styles.paddingHorizontal_15,
                {
                  borderBottomWidth: 2,
                  borderBottomColor:
                    active === 0 ? COLORS.darkRed : "transparent",
                  flex: 1,
                },
              ]}
            >
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                styles.paddingHorizontal_15,
                {
                  borderBottomWidth: 2,
                  borderBottomColor:
                    active === 1 ? COLORS.darkRed : "transparent",
                  flex: 1,
                },
              ]}
            >
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              ...
                              borderColor: username ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: phone ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: mail ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: idNum ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                              backgroundColor: idNum ? "#fff" : "#eee",
                            },
                          ]}
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: manufacturingYear
                                ? COLORS.darkRed
                                : "#eee",
                              borderWidth: 1,
                              backgroundColor: manufacturingYear
                                ? "#fff"
                                : "#eee",
                            },
                          ]}
                          onChangeText={(manufacturingYear) =>
                            setManufacturingYear(manufacturingYear)
                          }
                          value={
                            userData &&
                            userData.delegate &&
                            userData.delegate.year
                              ? userData.delegate.year.toString()
                              : ""
                          }
                          keyboardType={"number-pad"}
                          editable={false}
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: carType ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                              backgroundColor: carType ? "#fff" : "#eee",
                            },
                          ]}
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: carNumber ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                              backgroundColor: carNumber ? "#fff" : "#eee",
                            },
                          ]}
                          ...
                          value={
                            userData &&
                            userData.delegate &&
                            userData.delegate.car_plate_number
                              ? userData.delegate.car_plate_number
                              : ""
                          }
                          keyboardType={"number-pad"}
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: carChars ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                              backgroundColor: carChars ? "#fff" : "#eee",
                            },
                          ]}
                          ...
                          value={
                            userData &&
                            userData.delegate &&
                            userData.delegate.car_plate_letters
                              ? userData.delegate.car_plate_letters
                              : ""
                          }
                          editable={false}
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: area ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                              backgroundColor: area ? "#fff" : "#eee",
                            },
                          ]}
                        ...
                        <Input
                          style={[
                            styles.input,
                            {
                              borderTopRightRadius: 25,
                              borderTopLeftRadius: 25,
                              borderColor: city ? COLORS.darkRed : "#eee",
                              borderWidth: 1,
                              backgroundColor: city ? "#fff" : "#eee",
                            },
                          ]}
                ...
                <Input
                  style={[
                    styles.input,
                    {
                      borderTopRightRadius: 25,
                      borderTopLeftRadius: 25,
                      borderColor: password ? COLORS.darkRed : "#eee",
                      borderWidth: 1,
                ...
                <Input
                  style={[
                    styles.input,
                    {
                      borderTopRightRadius: 25,
                      borderTopLeftRadius: 25,
                      borderColor: newpass ? COLORS.darkRed : "#eee",
                      borderWidth: 1,
                ...
                <Input
                  style={[
                    styles.input,
                    {
                      borderTopRightRadius: 25,
                      borderTopLeftRadius: 25,
                      borderColor: confirmNewPass ? COLORS.darkRed : "#eee",
                      borderWidth: 1,
          ...
          >
            ...
            {userData && userData.delegate.attachments ? (
              ...
              >
                ...
                <Image
                  source={{ uri: userData.delegate.attachments.identity_img }}
                  style={[
                    styles.Width_100,
                    styles.height_120,
                    styles.Radius_5,
                ...
                <Image
                  source={{
                    uri: userData.delegate.attachments.car_plate_front_img,
                  }}
                  style={[
                    styles.Width_100,
                    styles.height_120,
                ...
                <Image
                  source={{
                    uri: userData.delegate.attachments.car_plate_end_img,
                  }}
                  style={[
                    styles.Width_100,
                    styles.height_120,
                ...
                <Image
                  source={{ uri: userData.delegate.attachments.car_plate_img }}
                  style={[
                    styles.Width_100,
                    styles.height_120,
                    styles.Radius_5,
