...
function BasketProduct({ pro, DeleteProducts, Decrease, Increase }) {
  ...
  return (
    <View>
      <ScrollView
        horizontal
        style={[styles.borderGray, styles.alignStart, styles.marginBottom_5]}
        contentContainerStyle={[
          styles.directionRow,
          styles.paddingHorizontal_10,
      ...
      >
        ...
        <View
          style={[
            ...
            { borderRightWidth: 1, borderLeftWidth: 1, borderColor: "#ddd" },
          ]}
        >
          <TouchableOpacity
            onPress={increment}
          ...
          >
            <Icon
              type={"AntDesign"}
              name={"plus"}
              style={[styles.textSize_12, styles.text_White]}
            />
          </TouchableOpacity>
          <Text
            style={[
          ...
          >
            <Icon
              type={"AntDesign"}
              name={"minus"}
              style={[styles.textSize_12, styles.text_gray]}
            />
          </TouchableOpacity>
        </View>
        ...
        <View style={[styles.directionRow]}>
          ...
          <TouchableOpacity onPress={DeleteProducts}>
            <Image
              ...
              style={[styles.icon25, { marginLeft: 10 }]}
              resizeMode={"contain"}
            />
          </TouchableOpacity>
        </View>
