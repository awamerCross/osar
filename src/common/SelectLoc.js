...
function SelectLoc({ navigation, route }) {
  ...
  const user = useSelector((state) =>
    state.auth.user != null ? state.auth.user.data : null
  );
      ...
      <Content contentContainerStyle={[styles.bgFullWidth, styles.bg_darkRed]}>
        ...
        >
          <View style={[styles.directionColumnCenter, styles.bgFullWidth]}>
            <Image
              source={
                user && user.user_type === 2
                  ? require("../../assets/images/home_order_vector.png")
                  : require("../../assets/images/vector_delivery.png")
              }
            ...
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("home", { locFrom: "current" })
              }
              style={[
                styles.mstrdaBtn,
                styles.Width_100,
