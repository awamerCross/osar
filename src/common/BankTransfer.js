...
function BankTransfer({ navigation, route }) {
  ...
  function renderSubmit() {
    ...
    if (
      ...
      accNum == "" ||
      amountToBeCharged == "" ||
      (title !== i18n.t("recoverBalance") ? base64 == "" : null)
    ) {
      return (
        <View
          style={[
        ...
        >
          <Text style={[styles.textBold, styles.text_gray, styles.textSize_14]}>
            {i18n.t("send")}
          </Text>
        </View>
      );
          ...
          <View style={[styles.Width_100]}>
            {title !== i18n.t("recoverBalance") ? (
              ...
              >
                ...
                >
                  {i18n.t("accName")} : {bank.account_name}
                </Text>
                <Text
                  style={[
                    styles.textBold,
                ...
                >
                  {i18n.t("bankName")} : {bank.bank_name}
                </Text>
                <Text
                  style={[
                    styles.textBold,
                ...
                >
                  {i18n.t("accNum")} : {bank.account_number}
                </Text>
                <Text
                  style={[
                    styles.textBold,
                  ...
                  <Input
                    style={[
                      styles.input,
                      {
                        ...
                        borderColor: bankName ? COLORS.darkRed : "#eee",
                        borderWidth: 1,
                        backgroundColor: bankName ? "#fff" : "#eee",
                      },
                    ]}
                  ...
                  <Input
                    style={[
                      styles.input,
                      {
                        borderTopLeftRadius: 20,
                        borderTopRightRadius: 20,
                        borderColor: accHolderName ? COLORS.darkRed : "#eee",
                        borderWidth: 1,
                        backgroundColor: accHolderName ? "#fff" : "#eee",
                      },
                    ]}
                  ...
                  <Input
                    style={[
                      styles.input,
                      {
                        borderTopLeftRadius: 20,
                        borderTopRightRadius: 20,
                        borderColor: accNum ? COLORS.darkRed : "#eee",
                        borderWidth: 1,
                        backgroundColor: accNum ? "#fff" : "#eee",
                      },
                    ]}
                  ...
                  <Input
                    style={[
                      styles.input,
                      {
                        borderTopLeftRadius: 20,
                        borderTopRightRadius: 20,
                        borderColor: amountToBeCharged
                          ? COLORS.darkRed
                          : "#eee",
                        borderWidth: 1,
                        backgroundColor: amountToBeCharged ? "#fff" : "#eee",
                      },
                    ]}
                    placeholder={i18n.t("amountToBeCharged")}
                    placeholderTextColor={COLORS.midGray}
                    onChangeText={(amountToBeCharged) =>
                      setAmountToBeCharged(amountToBeCharged)
                    }
