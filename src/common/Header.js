  ...
  return (
    <View
      style={[
        ...
        title !== i18n.t("selectNewLoc") ? styles.marginTop_20 : null,
        isIOS ? styles.height_50 : styles.height_80,
        isIOS ? styles.marginBottom_10 : null,
        ,
        styles.Width_100,
        title === i18n.t("selectNewLoc") ? styles.shadow : null,
        {
    ...
    >
      <View style={[styles.directionRow]}>
        ...
        !fromLoc ? (
          ...
          >
            <Image
              ...
              style={[styles.icon20, styles.transform]}
              resizeMode={"contain"}
            />
          </TouchableOpacity>
        ) : null}
        {token && title === i18n.t("home") && !fromLoc ? (
          <TouchableOpacity
            ...
            style={[styles.icon30, { marginRight: 15, padding: 5 }]}
          >
            <Image
              source={
                notifications.length > 0
                  ? require("../../assets/images/notication_acctive.png")
                  : require("../../assets/images/notification_non_active.png")
              }
              style={[styles.transform, styles.Width_100, styles.heightFull]}
              resizeMode={"contain"}
            />
          </TouchableOpacity>
        ) : null}
      ...
      <Text
        style={[
          ...
          styles.textCenter,
          {
            flex: title === i18n.t("selectLoc") || delegate ? 1 : 0,
            right:
              title === i18n.t("home") && delegate
                ? 30
                : title === i18n.t("home") && fromLoc
                ? -10
                : title === i18n.t("home")
                ? 10
                : 0,
      ...
      {title === i18n.t("home") && !delegate && !fromLoc ? (
              ...
              <View style={[styles.Width_100, styles.directionColumnCenter]}>
                <TouchableOpacity
                  ...
                  style={[
                    styles.Width_100,
                    styles.centerContext,
                    { borderBottomWidth: 1, borderColor: "#ddd", padding: 7 },
                  ]}
                >
                  <Text
                    style={[
        ...
        <View style={[styles.directionRow]}>
          {token ? (
            <TouchableOpacity onPress={onToggleFavorite}>
              <Icon
                style={[
                  likeIcon ? styles.text_red : styles.text_White,
                  styles.textSize_20,
                ]}
                type="AntDesign"
                name={"heart"}
        ...
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Image
            source={
              title === i18n.t("selectNewLoc")
                ? require("../../assets/images/arrow_gray_side.png")
                : require("../../assets/images/arrow_left.png")
            }
            style={[styles.icon20, styles.transform]}
            resizeMode={"contain"}
          />
